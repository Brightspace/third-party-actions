...
[actions/upload-code-coverage](https://github.com/Brightspace/third-party-actions/tree/actions/upload-code-coverage) | Upload a Cobertura XML coverage report to GitHub code coverage API
